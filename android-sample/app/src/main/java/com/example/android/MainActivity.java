    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            case 2: {
                ...
                Button test = (Button) rootView.findViewById(R.id.button_test);
                ...
                if (test != null) {
                    test.setOnClickListener(new View.OnClickListener() {
                        @Override public void onClick(View v) {
                            ...
                            Toast.makeText(getActivity(), "Clothes added!", Toast.LENGTH_LONG).show();
                        }
                    });
                }
                break;
                ...
                if (test != null) {
                    test.setOnClickListener(new View.OnClickListener() {
                        @Override public void onClick(View v) {
                            ...
                            Toast.makeText(getActivity(), "Pants added!", Toast.LENGTH_LONG).show();
                        }
                    });
                }
                break;
